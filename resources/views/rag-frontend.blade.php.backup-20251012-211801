...
<body>
  ...
  <div class="container py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <div class="d-flex gap-2">
        <button id="btnHealth" class="btn btn-outline-success btn-sm">🩺 Health</button>
        <button id="btnConfig" class="btn btn-outline-dark btn-sm">⚙️ Configurar</button>
      </div>
    </div>

    <div class="alert alert-light border bg-soft" role="alert">
      Base atual: <span class="mono" id="baseUrlLabel">(mesma origem)</span> ·
      Modelo padrão: <span class="mono" id="modelLabel">gemini-2.5-flash</span> ·
    ...
    <ul class="nav nav-tabs" id="mainTabs" role="tablist">
      ...
      <!-- DESATIVADAS - CENÁRIO MINIMALISTA -->
      ...
      <!-- ADMIN E CALCULADORA - Serão movidas para painel admin separado (futuro) -->
    ...
    <div class="tab-content border border-top-0 p-3 rounded-bottom">
      ...
      <div class="tab-pane fade show active" id="ing">
        <div class="row g-3">
          <div class="col-12 col-xl-6">
            ...
            <div class="mb-2">
              <label class="form-label">🎬 URL de Vídeo <small class="text-muted">• YouTube, Vimeo, etc</small></label>
            ...
            <div class="mb-2">
              ...
              <textarea id="ingText" class="form-control" rows="6" placeholder="Cole aqui um texto para ingestão"></textarea>
            </div>
            <div class="mb-2">
              <label class="form-label">Arquivos (PDF/Doc/etc.) <small class="text-muted">• Máx: 5 arquivos, 500MB, 5.000 páginas cada</small></label>
            ...
            <div class="d-grid"><button id="btnIngest" class="btn btn-primary">Enviar Ingestão</button></div>
          ...
          <div class="col-12 col-xl-6">
            <div class="mb-2">
              ...
              <div class="input-group">
                ...
                <button id="btnLoadLatest" class="btn btn-outline-secondary" type="button">Último</button>
              </div>
            </div>
            <div class="mb-2">
              <label class="form-label">Pergunta</label>
      ...
      <div class="tab-pane fade" id="python">
        <div class="row g-3">
          <div class="col-12 col-xl-6">
            ...
            <div class="mb-3">
              <label class="form-label fw-bold">📄 Escolher Documento</label>
              ...
              <div class="input-group">
                ...
                <button id="btnShowTranscription" class="btn btn-outline-primary" type="button" title="Ver transcrição completa (apenas para vídeos)" style="display:none;">
                  📄 Ver Transcrição
                </button>
              </div>
            ...
            <div id="pythonSuggestedQuestions" class="mb-3" style="display:none;">
              <label class="form-label">💡 Perguntas Sugeridas:</label>
            ...
            <div class="mb-3">
              <div class="form-check">
                ...
                <label class="form-check-label fw-bold">🧠 Modo Inteligente (Recomendado)</label>
                <br><small class="form-text text-muted">Sistema decide automaticamente a melhor estratégia</small>
              </div>
            </div>
            
            <div class="d-grid gap-2 mb-3">
              <button id="pythonSearchBtn" class="btn btn-primary btn-lg">🔍 Buscar</button>
            </div>
            ...
            <!-- CONTROLES AVANÇADOS (colapsável) -->
            <div class="collapse" id="pythonAdvancedOptions">
              <div class="card card-body bg-light">
                <h6 class="text-muted">Controles Técnicos</h6>
                ...
                <div class="row gx-2 mb-2">
                  ...
                  <div class="col-6">
                    <label class="form-label small">Citações (0-10)</label>
                    <input id="pythonCitations" class="form-control form-control-sm" type="number" value="0" min="0" max="10">
                  </div>
                </div>
                
                <div class="d-flex gap-2 mt-3">
                  <button id="pythonCompareBtn" class="btn btn-outline-secondary btn-sm">⚖️ Comparar PHP vs Python</button>
                  <button id="pythonHealthBtn" class="btn btn-outline-info btn-sm">🏥 Health Check</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="mb-2">
              ...
              <div id="feedbackSection" class="mt-2" style="display:none;">
                <div class="d-flex align-items-center gap-2">
                  <small class="text-muted">Esta resposta foi útil?</small>
                  <button id="feedbackThumbsUp" class="btn btn-sm btn-outline-success" title="Resposta útil">
                    👍 Útil
                  </button>
                  <button id="feedbackThumbsDown" class="btn btn-sm btn-outline-danger" title="Resposta não útil">
                    👎 Não útil
                  </button>
      ...
      <div class="tab-pane fade" id="gen">
        <div class="row g-3">
          <div class="col-12 col-xl-6">
            ...
            <div class="row gx-2">
              <div class="col-6"><label class="form-label">Modelo</label><input id="gModel" class="form-control" placeholder="gemini-2.5-flash (padrão)"></div>
              <div class="col-6"><label class="form-label">Location</label><input id="gLoc" class="form-control" placeholder="global (padrão)"></div>
            </div>
            <div class="mb-2">
      ...
      <div class="tab-pane fade" id="metrics">
        <div class="row g-3">
          <div class="col-12 col-xl-6">
            <h6>Métricas do Sistema</h6>
            <div class="d-grid gap-2">
              <button id="btnMetrics" class="btn btn-outline-primary">Carregar Métricas</button>
              <button id="btnCacheStats" class="btn btn-outline-info">Estatísticas de Cache</button>
              <button id="btnEmbeddingsStats" class="btn btn-outline-success">Estatísticas de Embeddings</button>
            </div>
            
            <div class="mt-3">
              <h6>📊 Feedback & Analytics</h6>
              <div class="d-grid gap-2">
                <button id="btnFeedbackStats" class="btn btn-outline-primary">📈 Estatísticas de Feedback</button>
                <button id="btnRecentFeedbacks" class="btn btn-outline-secondary">📝 Feedbacks Recentes</button>
              </div>
            </div>
          ...
          <div class="col-12 col-xl-6">
            <h6>Resultado</h6>
            <pre id="metricsOut" class="mono p-3 border rounded bg-soft">Clique em um botão para carregar métricas...</pre>
          </div>
        </div>
      </div>
      ...
      <div class="tab-pane fade" id="admin">
        <div class="row g-3">
          ...
          <div class="col-12 col-xl-6">
            <h6>Resultado</h6>
            <pre id="adminOut" class="mono p-3 border rounded bg-soft">Selecione uma ação administrativa...</pre>
          </div>
        </div>
      </div>
        ...
        <div class="row g-3">
          <div class="col-12 col-xl-8">
            <div class="alert alert-light border">
              <div><strong>Tabela (USD)</strong> baseada na página oficial de preços da Vertex AI. Valores por <em>1M tokens</em> (ou <em>1M caracteres</em> quando indicado).</div>
              <div class="small text-secondary">Última verificação: set/2025. Confirme sempre no site oficial.</div>
            </div>
            ...
            <div class="row gx-2 mt-2">
              ...
              <div class="col-12 col-md-6"><label class="form-label">Saída (tokens, quando aplicável)</label><input id="ccOut" type="number" class="form-control" placeholder="ex.: 800"></div>
            </div>
            ...
            <div class="form-text">Regra prática: ~4 caracteres ≈ 1 token.</div>
  ...
  <div class="modal" tabindex="-1" id="cfgModal"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title">Configuração</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
    <div class="modal-body">
      ...
      <div class="mb-2"><label class="form-label">Modelo padrão</label><input id="cfgModel" class="form-control" placeholder="gemini-2.5-flash"></div>
    </div>
  ...
  <div class="fixed-console">
    ...
    <div class="console-body p-2" id="consoleBody">
      <table class="table table-striped table-bordered table-log mb-0">
        <thead class="table-light"><tr><th>#</th><th>Método</th><th>URL</th><th>Status</th><th>ms</th><th>Ver</th></tr></thead>
  ...
  <script>
    ...
    function pushLog(entry){
      ...
      tr.innerHTML=`<td>${entry.id}</td><td>${entry.method}</td><td class="mono">${entry.url}</td><td>${entry.status}</td><td>${entry.ms}</td><td>▶</td>`;
      ...
      return new Promise((resolve,reject)=>{
        ...
        xhr.onreadystatechange = ()=>{
          if (xhr.readyState === 4){
            ...
            let respJson=null;
            try{ respJson = JSON.parse(xhr.responseText); } catch(_){ respJson = {status:xhr.status, text:"Resposta não-JSON"}; }
            pushLog({
              id:LOGSEQ++,
    ...
    document.getElementById("btnHealth").addEventListener("click", async ()=>{
      ...
      try{
        ...
        else { dot.className="badge-dot bg-warning"; txt.textContent="Falha lógica"; }
      } catch {
    ...
    function initDropzone(zoneId, inputId, listId){
      ...
      function render(){
        ...
        files.forEach((f, idx)=>{
          ...
          chip.innerHTML = `<span class="mono">${f.name}</span><span class="text-muted small">${(f.size/1024).toFixed(1)} KB</span><span class="x" data-idx="${idx}">×</span>`;
    ...
    document.getElementById("btnIngest").addEventListener("click", async ()=>{
      ...
      if (metaRaw) { try { meta = JSON.parse(metaRaw); } catch(e){ out.textContent = "Metadata inválida: " + e.message; return; } }
      ...
      try {
        ...
        if (videoUrlVal) {
          ...
          const progressSteps = [
            { pct: 10, msg: "🎬 Baixando vídeo..." },
            { pct: 30, msg: "🎵 Extraindo áudio..." },
            { pct: 60, msg: "🗣️ Transcrevendo com IA..." },
            { pct: 90, msg: "📝 Criando chunks..." }
          ];
          ...
          try {
            ...
            if (data.ok) {
              ...
              let outputHtml = '<div class="alert alert-success"><strong>✅ Vídeo processado com sucesso!</strong></div>';
              ...
              outputHtml += `<p><strong>🎬 Título:</strong> ${data.title}</p>`;
              outputHtml += `<p><strong>🔗 URL:</strong> <a href="${videoUrlVal}" target="_blank">${videoUrlVal}</a></p>`;
              outputHtml += `<p><strong>📄 Documento:</strong> #${data.document_id}</p>`;
              outputHtml += `<p><strong>📝 Chunks:</strong> ${data.chunks_created}</p>`;
              ...
              outputHtml += `<p><strong>⏱️ Duração:</strong> ${durationStr}</p>`;
              outputHtml += `<p><strong>🎯 Confiança:</strong> ${Math.round(data.confidence * 100)}%</p>`;
              outputHtml += '</div></div>';
              ...
              if (data.transcription_text) {
                out.innerHTML += '<div class="alert alert-info mt-3">📄 Transcrição completa disponível - <a href="#" onclick="const modal = new bootstrap.Modal(document.getElementById(\'transcriptionModal\')); modal.show(); return false;">clique aqui para ver</a></div>';
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title">📄 Transcrição do Vídeo</h5>
                        ...
                        <div class="modal-body">
                          <div class="mb-3">
                            ...
                            <small class="text-muted">${data.transcription_length} caracteres • ${data.chunks_created} chunks</small>
                          </div>
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-primary" onclick="
                            ...
                            setTimeout(() => this.textContent = '📋 Copiar Transcrição', 2000);
                          ">📋 Copiar Transcrição</button>
            ...
            out.textContent = "❌ Erro: " + (error.message || error);
          }
          
          document.getElementById("ingVideoUrl").value = "";
          setTimeout(() => pWrap.classList.add("d-none"), 3000);
          return;
        }
        ...
        if (files.length > 0) {
          ...
          if (window.FileValidator) {
            ...
            if (!validation.valid) {
              out.textContent = "❌ Validação falhou:\n" + validation.errors.join('\n');
              return;
            }
          }
    ...
    document.getElementById("btnLoadLatest").addEventListener("click", async ()=>{
      try{
        ...
        if (data && data.docs && data.docs.length > 0) {
          const latest = data.docs[0]; // Primeiro é o mais recente
    ...
    document.getElementById("btnGenGET").addEventListener("click", async ()=>{
      ...
      // GET normalmente ignora corpo/arquivos; usado só para teste rápido
      try{
    ...
    document.getElementById("btnMetrics").addEventListener("click", async ()=>{
      ...
      out.textContent="Carregando métricas...";
      try{
    ...
    document.getElementById("btnCacheStats").addEventListener("click", async ()=>{
      const out=document.getElementById("metricsOut");
      out.textContent="Carregando estatísticas de cache...";
      try{
    ...
    document.getElementById("btnEmbeddingsStats").addEventListener("click", async ()=>{
      const out=document.getElementById("metricsOut");
      out.textContent="Carregando estatísticas de embeddings...";
      try{
    ...
    document.getElementById("btnFeedbackStats").addEventListener("click", async ()=>{
      const out=document.getElementById("metricsOut");
      out.textContent="Carregando estatísticas de feedback...";
      try{
...
Feedbacks positivos (👍): ${stats.positive_feedbacks}
Feedbacks negativos (👎): ${stats.negative_feedbacks}
Taxa de satisfação: ${stats.satisfaction_rate}%
...
${topQueries.length > 0 ? topQueries.map((q, i) => 
  `${i+1}. "${q.query.substring(0, 60)}${q.query.length > 60 ? '...' : ''}"
     Rating: ${q.avg_rating.toFixed(2)} | Avaliações: ${q.count}`
).join('\n\n') : 'Sem dados suficientes (mínimo 2 avaliações por query)'}
...
${topDocs.length > 0 ? topDocs.map((d, i) => 
  `${i+1}. Doc ID: ${d.document_id} - ${d.document ? d.document.title : 'Sem título'}
     Rating: ${d.avg_rating.toFixed(2)} | Avaliações: ${d.count}`
).join('\n\n') : 'Sem dados suficientes (mínimo 3 avaliações por documento)'}

═══════════════════════════════════════
TENDÊNCIA (ÚLTIMOS 7 DIAS):
═══════════════════════════════════════
${daily.length > 0 ? daily.map(d => 
  `${d.date}: ${d.total} feedbacks (${d.positive} 👍 / ${d.negative} 👎)`
).join('\n') : 'Sem dados nos últimos 7 dias'}
          `;
          
          out.textContent = html;
        } else {
          out.textContent = "Erro: " + (data.error || "Resposta inválida");
        }
      }catch(e){ out.textContent="Erro: "+e.message; }
    });
...
${feedbacks.length > 0 ? feedbacks.map((f, i) => {
  const rating = f.rating === 1 ? '👍 POSITIVO' : '👎 NEGATIVO';
  ...
  return `${i+1}. ${rating} | ${date}
   ...
   ───────────────────────────────────────`;
    ...
    document.getElementById("btnBatchIngest").addEventListener("click", async ()=>{
      const out=document.getElementById("adminOut");
      out.textContent="Upload em lote não implementado no frontend ainda...";
    });

    document.getElementById("btnQualityIngest").addEventListener("click", async ()=>{
      const out=document.getElementById("adminOut");
      out.textContent="Upload com qualidade não implementado no frontend ainda...";
    });
    ...
    document.getElementById("pythonSearchBtn").addEventListener("click", async ()=>{
      ...
      try {
        ...
        if (data.ok || data.success) {
          ...
          // MOSTRAR BOTÕES DE FEEDBACK após resposta bem-sucedida
          if (data.answer) {
          ...
          if (metadata.smart_router) {
            ...
            const badge = `<span class="badge bg-info ms-2">🧠 Smart: ${smartInfo.strategy}</span>`;
            document.getElementById("pythonStatus").innerHTML += badge;
          }
          
          // Exibir badge se veio do cache
          if (metadata.cache_hit) {
            const cacheBadge = `<span class="badge bg-success ms-2">⚡ Cache ${metadata.cache_level}</span>`;
        ...
        if (data.success) {
          ...
          document.getElementById("pythonStatus").innerHTML = `
            <div class="alert alert-success">
              <h6>📊 Comparação PHP vs Python</h6>
              <div class="row">
                <div class="col-6">
                  <strong>PHP (FTS):</strong><br>
                  ✅ Sucesso: ${php.success}<br>
                  📄 Chunks: ${php.chunks_found}<br>
                  ⏱️ Tempo: ${php.execution_time}s
                </div>
                <div class="col-6">
                  <strong>Python (Vector):</strong><br>
                  ✅ Sucesso: ${python.success}<br>
                  📄 Chunks: ${python.chunks_found}<br>
                  ⏱️ Tempo: ${python.execution_time}s
                </div>
              </div>
              <hr>
              <strong>🏆 Vencedor:</strong> Velocidade: ${data.winner.speed} | Chunks: ${data.winner.chunks}
            </div>
          `;
    ...
    document.getElementById("pythonHealthBtn").addEventListener("click", async ()=>{
      document.getElementById("pythonStatus").innerHTML = '<div class="alert alert-info">🏥 Verificando saúde do sistema Python...</div>';
      ...
      try {
        ...
        if (data.success) {
          document.getElementById("pythonStatus").innerHTML = `
            <div class="alert alert-success">
              <h6>🏥 Sistema Python RAG - Saudável</h6>
              <div class="row">
                <div class="col-6">
                  <strong>Python:</strong> ${data.python_version}<br>
                  <strong>Script:</strong> ✅ Encontrado<br>
                  <strong>Dependências:</strong> ✅ OK
                </div>
                <div class="col-6">
          ...
          document.getElementById("pythonStatus").innerHTML = `<div class="alert alert-danger">❌ Sistema com problemas: ${data.error}</div>`;
        }
...
<script>
  // Função para auto-selecionar documento após upload
  async function autoSelectDocument(documentId) {
    try {
      console.log(`🎯 Auto-selecionando documento ID: ${documentId}`);
      ...
      // 5. Mostra notificação visual
      showDocumentActiveNotification(documentId);
      
      console.log(`✅ Documento ${documentId} selecionado e aba Python RAG ativada`);
    } catch (error) {
      console.error("Erro ao auto-selecionar documento:", error);
    }
  }
  
  // Função para mostrar notificação de documento ativo
  function showDocumentActiveNotification(documentId) {
    // Busca o título do documento
    const pythonDocSelect = document.getElementById('pythonDocSelect');
    ...
    // 2. Remove notificação anterior se existir
    const oldNotif = document.getElementById('activeDocNotification');
    if (oldNotif) oldNotif.remove();
    
    // 3. Cria notificação temporária
    ...
    notif.innerHTML = `
      <strong>✅ Documento Selecionado!</strong><br>
    ...
    try {
      ...
      if (data && data.docs && Array.isArray(data.docs)) {
        ...
        realDocs.slice(0, 15).forEach(doc => {
          // Melhora a formatação do nome
          let displayName = doc.title;
          let fileIcon = '📄'; // ícone padrão
          let fileExtension = ''; // extensão do arquivo
          
          // Define ícone baseado na extensão (símbolos universais reconhecíveis)
          if (displayName.endsWith('.pdf')) {
            fileIcon = '📕'; // Adobe PDF - documento vermelho clássico
            fileExtension = '.pdf';
            displayName = displayName.replace('.pdf', '');
          } else if (displayName.endsWith('.docx') || displayName.endsWith('.doc')) {
            fileIcon = '📘'; // Microsoft Word - documento azul clássico
            ...
            fileIcon = '📗'; // Microsoft Excel - planilha verde clássica
            ...
            fileIcon = '📙'; // Microsoft PowerPoint - apresentação laranja clássica
            ...
            fileIcon = '🖼️'; // WebP - imagem moderna
            fileExtension = '.webp';
        ...
        console.log(`✓ ${realDocs.length} documentos reais carregados nos selects (filtrados de ${data.docs.length} total)`);
      }
    } catch (error) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btnShowTranscription').addEventListener('click', async function() {
      ...
      try {
          ...
          <div class="modal fade" id="transcriptionModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    <strong>🎬 ${docData.title}</strong><br>
                    <small class="text-muted">${transcription.length} caracteres • ${chunks.length} chunks</small>
                  </div>
        ...
        alert('Erro ao carregar transcrição: ' + (error.message || error));
      }
    });
  });
  ...
  window.addEventListener("load", function() {
    ...
    // Aguarda um pouco para garantir que window.RAG está disponível
    setTimeout(function() {
      if (!window.RAG) {
        console.error("window.RAG não está disponível!");
        return;
      }
      
      console.log("✓ window.RAG disponível, registrando event listener");
      ...
      document.getElementById("pythonDocId").addEventListener("change", async function() {
        ...
        try {
          ...
          if (questions && questions.length > 0) {
            ...
            console.log("✓ Perguntas exibidas!");
          } else {
            document.getElementById("pythonSuggestedQuestions").style.display = "none";
  ...
  // FEEDBACK SYSTEM - Event listeners para botões 👍👎
  ...
  document.getElementById("feedbackThumbsUp").addEventListener("click", async function() {
    ...
    try {
      ...
      if (result && result.ok) {
        document.getElementById("feedbackStatus").textContent = "✓ Obrigado pelo feedback!";
  ...
  document.getElementById("feedbackThumbsDown").addEventListener("click", async function() {
    ...
    try {
      ...
      if (result && result.ok) {
        document.getElementById("feedbackStatus").textContent = "✓ Obrigado pelo feedback! Vamos melhorar.";
        document.getElementById("feedbackStatus").style.display = "inline";
